...
export default function Cards({big = false, imgUrl = "", srcset = ""}) {
    return (
        <div className={`lazy w-full h-96 lg:h-xxl transform rounded relative ${big ? "lg:scale-105" : "lg:scale-95"}`}>
            {/*<img src={imgUrl}*/}
            ...
            {/*    // data-sizes="100w"*/}
            {/*/>*/}
            <div className="lazy bg-cover bg-center bg-no-repeat w-full h-full"  data-bg={imgUrl}></div>
            <div
