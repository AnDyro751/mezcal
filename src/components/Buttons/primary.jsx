export default function ButtonsPrimary({onClick = null, text = "", disabled = false, loading = false, children = null, customClass = null}) {
    return (
        <button disabled={disabled || loading} onClick={onClick}
                className={`${disabled || loading ? "cursor-not-allowed opacity-75 bg-gray-400" : ""} ${customClass} hover:opacity-75 h-12 disabled:cursor-not-allowed bg-black flex items-center text-white px-5 py-3 rounded font-normal`}
        >
            {loading ?
